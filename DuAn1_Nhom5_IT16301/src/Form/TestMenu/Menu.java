...
public class Menu extends javax.swing.JPanel {
    ...
    private void init(){
        listMenu.addItem(new Model_Menu("1", "Quản lý tài khoản", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("3", "Quản lý danh mục sản phẩm", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("2", "Quản lý khách hàng", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("4", "Quản lý sản phẩm", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("6", "Quản lý hóa đơn", Model_Menu.MenuType.MENU));
        ...
        listMenu.addItem(new Model_Menu("11", "Đăng xuất", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("12", "Thoát", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Jewelry store manager");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(listMenu, javax.swing.GroupLayout.PREFERRED_SIZE, 609, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
